...
class costumeSection(models.Model):
...
class   costumeFeature(models.Model):
...
class  costumecourse(models.Model):
    title = models.CharField(max_length=200)
    description = models.TextField()
...
class  costumeCoursesyllbi(models.Model):
...
class costumeCourseSyllabus(models.Model):
    course = models.ForeignKey(costumeCoursesyllbi, related_name='syllabus', on_delete=models.CASCADE)
    title = models.CharField(max_length=255)
    description = models.TextField()
...
class costumeDuration(models.Model):
    course = models.OneToOneField(costumecourse,on_delete=models.CASCADE)
...
class costumeCardSliderItem(models.Model):
