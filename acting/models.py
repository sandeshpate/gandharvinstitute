...
class ActingSection(models.Model):
...
class ActingFeature(models.Model):
...
class ActingSyllabus(models.Model):
...
class ActDuration(models.Model):
    course = models.OneToOneField(Acting, on_delete=models.CASCADE)
...
class ActingCardSliderItem(models.Model):
    title = models.CharField(max_length=255)
    # subtitle = models.CharField(max_length=255, blank=True, null=True)
    # description = models.TextField()
    image = models.ImageField(upload_to='actingimages/' ,blank=True, null=True)
