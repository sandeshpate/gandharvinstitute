...
class singingSection(models.Model):
...
class singingFeature(models.Model):
...
class singingcourse(models.Model):
    title = models.CharField(max_length=200)
    description = models.TextField()
...
class singingCoursesyllbi(models.Model):
...
class singingCourseSyllabus(models.Model):
    course = models.ForeignKey(singingCoursesyllbi, related_name='syllabus', on_delete=models.CASCADE)
    title = models.CharField(max_length=255)
    description = models.TextField()
...
class singingDuration(models.Model):
    course = models.OneToOneField(singingcourse, on_delete=models.CASCADE)
...
class singingCardSliderItem(models.Model):
